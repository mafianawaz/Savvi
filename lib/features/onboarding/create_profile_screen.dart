...
/// "Create your account" — the member profile form. Phone is REQUIRED (locked
/// founder decision). Profile creation is gated on a verified access grant; if
/// none exists the form shows an "Access link required" banner and routes back
/// to verification. The backend assigns the member ID and initial approval
/// state on submit; the client sends only entered fields.
...
//
//     // Client sends only member-entered fields. Backend owns ID + approval.
//     final body = {
...
//       'zip': _zip.text.trim(),
//       'household': _household == 11 ? '10+' : '$_household',
//       'accessState': grant.state.api,
//       // Password is sent to the auth layer, not stored by the client.
//     };
//     final approval = await ref.read(profileControllerProvider.notifier).submit(body);
//     if (!mounted) return;
//     context.go(Routes.approval, extra: approval);
//   }
//
//   @override
//   Widget build(BuildContext context) {
//     final l = AppLocalizations.of(context);
//     final grant = ref.watch(accessGrantProvider);
//     final submitting =
//         ref.watch(profileControllerProvider) is ProfileSubmitting;
//
//     return AuthScaffold(
//       title: l.signUpTitle,
...
//             message: l.signUpAccessVerifiedBody,
//           ),
...
//               ),
//               const SizedBox(height: SavSpace.x14),
//               // Phone — REQUIRED (locked decision). No SMS is implied.
//               SavField(
//                 label: l.fieldPhone,
//                 controller: _phone,
//                 hint: l.hintPhone,
...
//                       child: Text(l.actionSignInShort,
//                           style: const TextStyle(
//                               fontFamily: SavFonts.sans,
//                               fontSize: 13,
...
//                   size: 16, color: SavColors.pillAmberFg),
//               const SizedBox(width: SavSpace.x8),
//               Text(l.signUpAccessRequiredTitle,
//                   style: const TextStyle(
//                       fontFamily: SavFonts.sans,
//                       fontSize: 12.5,
//                       fontWeight: FontWeight.w700,
...
//           Text(l.signUpAccessRequiredBody,
//               style: const TextStyle(
//                   fontFamily: SavFonts.sans,
//                   fontSize: 12,
//                   height: 1.45,
...
//             onPressed: () => context.go(Routes.accessLink),
//           ),
//         ],
//       ),
//     );
...
//       if (n == 11) return l.householdPeopleMax; // 11th slot = "10+"
...
//               items: [
//                 for (var n = 1; n <= 11; n++)
//                   DropdownMenuItem(value: n, child: Text(labelFor(n))),
//               ],
...
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         // Whole row is tappable so the target meets the 44px minimum.
//         InkWell(
//           onTap: toggle,
//           borderRadius: SavRadius.field,
//           child: Padding(
...
//         if (_consentError)
//           Padding(
//             padding: const EdgeInsets.only(top: SavSpace.x4, left: 2),
//             child: Text(l.consentRequired,
//                 style: const TextStyle(
//                     fontFamily: SavFonts.sans,
//                     fontSize: 11.5,
