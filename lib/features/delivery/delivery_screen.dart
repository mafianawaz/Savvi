...
/// Delivery status for an active request. Read-only, backend-driven. No driver
/// portal: driver details and exact routes are never shown (locked decision).
...
//       appBar: _bar(context, l.trackTitle),
//       body: async.when(
...
//             children: [
//               Text(l.requestIdLabel.toUpperCase(),
//                   style: const TextStyle(
//                       fontFamily: SavFonts.sans,
//                       fontSize: 11,
...
//               Text(r.categories.map((c) => Labels.category(l, c)).join(', '),
//                   style: const TextStyle(
//                       fontFamily: SavFonts.sans,
//                       fontSize: 12,
//                       fontWeight: FontWeight.w500,
...
//                     child: _etaItem(
//                         r.etaHi != null
//                             ? fmt.eta(lo: r.etaLo, hi: r.etaHi!)
//                             : '',
//                         l.trackEst)),
//                 Expanded(
//                     child: _etaItem(
//                         r.distanceMi != null
//                             ? fmt.distance(r.distanceMi!)
//                             : '',
//                         l.trackDist)),
//               ],
//             ),
