...
class _AlertCardState extends State<_AlertCard> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _locationRow(a.where, a.left, l),
                  const SizedBox(height: SavSpace.x12),
                  _directionsButton(context, l, a.where),
  ...
  /// Location + capacity on one row — plain metadata (not tappable itself;
  /// [_directionsButton] below is the actual maps affordance), matching the
  /// v56 reference where the address sits next to a "N remaining" pill.
  Widget _locationRow(String where, int left, AppLocalizations l) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Icon(Icons.place_outlined, size: 14, color: SavColors.txt3),
        const SizedBox(width: SavSpace.x6),
        Expanded(
          child: Text(
            where,
  ...
  /// Standalone outlined button that opens Google Maps, matching the v56
  /// reference's full-width "Get Directions" affordance below the meta rows
  /// (distinct from the RSVP button beneath it).
  Widget _directionsButton(
    ...
    return SizedBox(
      ...
      child: OutlinedButton.icon(
        onPressed: () => _openDirections(context, l, where),
